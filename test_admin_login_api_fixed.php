...
$loginData = [
    'account' => 'superadmin',  // AuthController期望'account'字段
    'password' => 'admin123456'
];

$loginUrl = 'http://localhost:8000/admin/login';  // 正确的路由URL
...
if ($loginHttpCode === 200) {
    ...
    if (isset($loginData['token'])) {
        ...
        $statsUrl = 'http://localhost:8000/admin/resources/stats';  // 正确的资源API路径
        ...
        $resourcesUrl = 'http://localhost:8000/admin/resources';  // 正确的资源列表API路径
