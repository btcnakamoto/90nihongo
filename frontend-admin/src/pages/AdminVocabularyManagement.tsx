...
const AdminVocabularyManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      <AdminSidebar activePath="/admin/content/vocabulary" />
      <div className={cn(
        "flex-1 bg-gradient-to-br from-gray-50 to-gray-100 transition-all duration-300 main-content",
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium">{word.mastery_rate}%</span>
                                                              ...
                                                              <Badge className={getMasteryColor(word.mastery_rate)}>                                {getMasteryText(word.mastery_rate)}                              </Badge>
                              </div>
